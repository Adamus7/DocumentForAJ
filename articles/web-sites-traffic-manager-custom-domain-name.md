<properties
	pageTitle="Configuring a custom domain name for a web app in Azure App Service using Traffic Manager"
	description="Use a custom domain name for a web app that includes Traffic Manager for load balancing."
	services="web-sites"
	documentationCenter=""
	authors="cephalin"
	manager="wpickett"
...
This article provides generic instructions for using a custom domain name with Azure App Servic that use Traffic Manager for load balancing.
...
-   [Configure your apps for Standard mode](#bkmk_configsharedmode)
...
To associate your custom domain with an Azure App Service, you must add a new entry in the DNS table for your custom domain by using tools provided by the domain registrar that you purchased your domain name from. Use the following steps to locate and use the DNS tools.
