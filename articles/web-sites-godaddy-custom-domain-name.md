...
This article provides instructions on using a custom domain name purchased from [Go Daddy](https://godaddy.com) with App Service Web Apps.
...
-   [Enable the domain on your web app](#enabledomain)
